...
namespace GestaoDeTarefas.Repository {
  ...
  public class ListaRepositorioFirebird : IListaTarefasRepositorio {
    ...
    public ListaRepositorioFirebird(FbConnection conexao) {
      this.conexao = conexao;
    }

    public String Adicionar(ListaDeTarefas lista) {
    ...
    public String Editar(ListaDeTarefas lista) {
